"""
Batch sampling script for Fisher-Rao Flow Matching BERT models.

Usage:
    python -u examples/bert_sfm/sample.py --model_name_or_path "YOUR_MODEL_PATH"
"""
...
print("\n" + "=" * 80)
print("TEST: BertSFM.sample()".center(80))
print("=" * 80)
...
print("\n" + "=" * 80)
print("TEST: BertSFM.infill()".center(80))
print("=" * 80)
