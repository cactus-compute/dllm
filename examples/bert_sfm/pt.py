"""
Fisher-Rao Flow Matching Pretraining for BERT.
...
- 1 Node, 8 GPUs (ZeRO-2):
    sbatch --gres=gpu:8 scripts/train.slurm.sh \
        ...
        --script_path "examples/bert_sfm/pt.py"
"""
...
class TrainingArguments(BertSFMTrainer.BertSFMConfig):
    output_dir: str = "models/ModernBERT-base-sfm/tiny-shakespeare"
